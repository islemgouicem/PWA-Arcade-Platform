-- Fix ambiguous "id" references inside get_zone_entries_for_team.
-- In PL/pgSQL RETURNS TABLE, output column names (like "id") are variables,
-- so unqualified "id" in SQL statements can collide and trigger 42702.
