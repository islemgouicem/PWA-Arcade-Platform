-- Hint activation must always use the current active mission.
-- linked_mission_id is ignored for hint resolution.
...
BEGIN
  ...
  ELSIF v_card.card_type = 'hint_single' THEN
    ...
    IF v_hint.id IS NULL THEN
      RAISE EXCEPTION 'No unused hint available for this team at this level';
    END IF;
